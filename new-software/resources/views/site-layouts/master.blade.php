...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Xcelerate | Dashboard &amp; Web App Template</title>
    <meta name="csrf-token" content="{{ csrf_token() }}" />

    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url('/static/assets/img/favicons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('/static/assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('/static/assets/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('/static/assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ url('/static/assets/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage" content="{{ url('/static/assets/img/favicons/mstile-150x150.png') }}">
    <meta name="theme-color" content="#ffffff">
    <script src="{{ url('/static/assets/js/config.js') }}"></script>
    <script src="{{ url('/static/vendors/simplebar/simplebar.min.js') }}"></script>
    ...
    <link href="{{ url('/static/vendors/simplebar/simplebar.min.css') }}" rel="stylesheet">
    <link href="{{ url('/static/assets/css/theme-rtl.min.css') }}" rel="stylesheet" id="style-rtl">
    <link href="{{ url('/static/assets/css/theme.min.css') }}" rel="stylesheet" id="style-default">
    <link href="{{ url('/static/assets/css/user-rtl.min.css') }}" rel="stylesheet" id="user-style-rtl">
    <link href="{{ url('/static/assets/css/user.min.css') }}" rel="stylesheet" id="user-style-default">
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        @if(Auth::user()->hasRole('user'))
            ...
            @include('site-layouts.partials.user-sidebar')

        @endif

         @if(Auth::user()->hasRole('admin'))
                 
            @include('site-layouts.partials.admin-sidebar')

        @endif

        
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg" style="display: ;">
          <button class="btn navbar-toggler-humburger-icon navbar-toggler me-1 me-sm-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarStandard" aria-controls="navbarStandard" aria-expanded="false" aria-label="Toggle Navigation"><span class="navbar-toggle-icon"><span class="toggle-line"></span></span></button>
          <a class="navbar-brand me-1 me-sm-3" href="index.html"> 
            <div class="d-flex align-items-center"><img class="me-2" src="{{ url('static/assets/img/icons/spot-illustrations/falcon.png') }}" alt="" width="40" /><span class="font-sans-serif">falcon</span></div>
          </a>
                    ...
                    <div class="list-group list-group-flush fw-normal fs--1">
                        ...
                        <a class="notification notification-flush notification-unread" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-2xl me-3">
                              <img class="rounded-circle" src="{{ url('/static/assets/img/team/1-thumb.png') }}" alt="" />
                            </div>
                          </div>
                      ...
                      <div class="list-group-item">
                        <a class="notification notification-flush" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-2xl me-3">
                              <img class="rounded-circle" 3-s/weather-sm.jpg" alt="" />
                            </div>
                          </div>
                          <div class="notification-body">
    ...
    <script src="{{ url('/static/vendors/popper/popper.min.js') }}"></script>
    <script src="{{ url('/static/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ url('/static/vendors/anchorjs/anchor.min.js') }}"></script>
    <script src="{{ url('/static/vendors/is/is.min.js') }}"></script>
    <script src="{{ url('/static/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ url('/static/vendors/lodash/lodash.min.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ url('/static/vendors/list.js/list.min.js') }}"></script>
    <script src="{{ url('/static/assets/js/theme.js') }}"></script>
    <script src="{{ url('/static/custom.js') }}"></script>
