          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
               ...
               <a class="nav-link dropdown-indicator nav-link-text" href="#events" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="events">
               <div class="d-flex align-items-center">
               <span class="nav-link-icon">
              
                <span class="fa fa-users"></span>
               </span>
               <span class="nav-link-text ps-1" style="color: var(--falcon-navbar-vertical-link-color);">Manage Users</span>
               </div>
               </a>
               ...
               <li class="nav-item">
               <a class="nav-link" href="{{ url('admin/users/retail') }}">
               <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Retail Users</span></div>
               </a>
               <!-- more inner pages-->
               </li>
               <li class="nav-item">
               <a class="nav-link" href="{{ url('/admin/users/send-email') }}"> 
               <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Email to All </span></div>
               </a>
               <!-- more inner pages-->
               </li>
               </ul>
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="{{ url('/admin/resources') }}">
                        <div class="d-flex align-items-center">
                           <span class="fas fa-chart-pie"></span>
                           <span class="nav-link-text ps-1">Resources</span>
                        </div>
                     </a><!-- more inner pages-->
                  </li>  
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="{{ url('admin/zoom') }}">
                        <div class="d-flex align-items-center">
                           ...
                           <span class="nav-link-text ps-1">Zoom</span>
                        </div>
                     </a><!-- more inner pages-->
                  </li> 
                   ...
                   <li class="nav-item">
                     <a class="nav-link" href="{{ url('admin/messages') }}">
                        <div class="d-flex align-items-center">
                           ...
                           <span class="nav-link-text ps-1">Notification</span>
                        </div>
                     </a><!-- more inner pages-->
                  </li> 

                  <li class="nav-item">
                     <a class="nav-link" href="{{ url('admin/users-subscriptions') }}">
                        <div class="d-flex align-items-center">
                           <span class="fa fa-retweet"></span>
                           <span class="nav-link-text ps-1">Subscriptions</span>
                        </div>
                     </a><!-- more inner pages-->
                  </li>

  
            <a class="nav-link dropdown-indicator nav-link-text" href="#tickets" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="events">
            <div class="d-flex align-items-center">
            <span class="nav-link-icon">
           
             <span class="fa fa-ticket"></span>
            </span>
            <span class="nav-link-text ps-1" style="color: var(--falcon-navbar-vertical-link-color);">Support Tickets</span>
            </div>
            </a>

          <ul class="nav collapse" id="tickets">
               <li class="nav-item">
               <a class="nav-link" href="{{ url('admin/tickets') }}">
               <div class="d-flex align-items-center"><span class="nav-link-text ps-1">All Ticket</span></div>
               </a>
               <!-- more inner pages-->
               </li>
               <li class="nav-item">
               <a class="nav-link" href="{{ url('admin/users/') }}">
               <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Pending Ticket</span></div>
               </a>
               <!-- more inner pages-->
               </li>
               <li class="nav-item">
               <a class="nav-link" href="{{ url('/admin/users/') }}"> 
               <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Closed Ticket</span></div>
               </a>
               <!-- more inner pages-->
               </li>
               <li class="nav-item">
               <a class="nav-link" href="{{ url('/admin/users/') }}"> 
               <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Answered Ticket</span></div>
               </a>
               <!-- more inner pages-->
               </li>
               </ul>
