            ...
            <div class="card-body">
              <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                  <h6 class="mb-0">Showing 1-{{count($products)}} of {{ $products->total() }} Products</h6>
                </div>
                    ...
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          ...
                          <div class="mt-2">
                            <form action="{{ route('add.to.bucket') }}" method="POST" enctype="multipart/form-data">
                                @csrf
