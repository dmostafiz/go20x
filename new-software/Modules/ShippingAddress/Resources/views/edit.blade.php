...
<div class="mb-3 card">
	<div class="card-header">
		<div class="align-items-end g-2 row">
			<div class="col">
				<div class="d-flex">
					<h5 class="mb-0 hover-actions-trigger" id="example">Edit Shipping Address</h5></div>
			</div>
			{{-- <div class="col-auto">
				<div class="row">
					<div class="col">
	...
	<div class="bg-light card-body">
				<form class="" action="{{route('update.shipping',$address->id)}}" method="post">
				@csrf
				<div class="gx-2 gy-3 row">
					<div class="col-md-6">
						<div>
							<label class="form-label" for="firstname">First Name</label>
							<input placeholder="First Name" name="fname" type="text" id="firstname" class="form-control @error('fname') is-invalid @enderror" value="{{$address->first_name}}">
						</div>
						@if ($errors->has('fname'))
					...
					<div class="col-md-6">
						<div>
							...
							<input placeholder="Last Name" name="lname" type="text" id="last_name" class="form-control @error('lname') is-invalid @enderror" value="{{$address->last_name}}">
						</div>
						@if ($errors->has('lname'))
							<span class="invalid-feedback d-block" role="alert">
					...
					<div class="col-md-12">
						<div>
							...
							<input placeholder="Street" name="street" type="text" id="address" class="form-control @error('street') is-invalid @enderror" value="{{$address->address}}">
						</div>
					...
					<div class="col-md-12">
						<div>
							...
							<input placeholder="Apartment, house number, suite, etc. (optional)" name="street2" type="text" id="street2" class="form-control" value="{{$address->address_line_1}}">
						</div>
					</div>
					<div class="col-md-12">
						<div>
							...
							<select aria-label="Default select example" name="country" class="form-select @error('country') is-invalid @enderror" id="country" >
								...
								@foreach($countries as $country)
                                        ...
                                        {{ $address->country == $country['iso2'] ? "selected" : "" }}
					...
					<div class="col-md-4">
						<div>
							...
							<input placeholder="Zipcode" name="zipcode" type="text" id="zipcode" class="form-control @error('zipcode') is-invalid @enderror" value="{{$address->zipcode}}">
						</div>
					...
					<div class="col-md-12 mb-3">
						<div>
							...
							<input placeholder="Phone Number" name="phone" type="text" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{$address->phone_number}}">
						</div>
						@if ($errors->has('phone'))
							<span class="invalid-feedback d-block" role="alert">
				...
				<div class="text-end">
						<button type="submit" class="btn btn-primary" fdprocessedid="t2coi8">Update</button>
				</div>
				</form>
			</div>
</div>
